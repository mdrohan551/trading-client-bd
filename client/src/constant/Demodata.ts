// Add this to your constant/Demodata.ts file
// Replace the existing topMenu export with this updated version
...
export const headerContact: HeaderContact<"phone" | "location" | "email">[] = [
  {
    label:
      " M.Q PLAZA, 1ST FLOOR, 36 NO. WARD, FAKIRHAT, BANDAR, CHATTOGRAM-4100, BANGLADESH.",
    icon: LocationEdit,
    type: "location",
    ...
    pages: [
      {
        ...
        anchor: `Port Agency Services`,
        accordion: false,
      },
      {
        href: `/services/ship-chandling`,
        anchor: `Ship Chandling Services`,
        accordion: false,
      },
      {
...
export const servicesimages: ServiceImage[] = [
  {
    ...
    video:
      "https://res.cloudinary.com/dtsnbnrwf/video/upload/v1764418928/main_ibzjau.mp4",
  },
  {
    id: 2,
    src: "/images/ggg.jpg",
    ...
    video:
      "https://res.cloudinary.com/dtsnbnrwf/video/upload/v1764418471/Exportmall_limzhp.mp4 ",
  },
  {
    id: 3,
    src: "/images/505.jpg",
    ...
    video:
      "https://res.cloudinary.com/dtsnbnrwf/video/upload/v1764419274/Ship_Chandler_2_rl3fdc.mp4",
  },
];

// OUR SERVICES

// Updated with links to service pages
export const OurBusinesssData: BusinessItem[] = [
  {
    id: 1,
    title: "Ship Chandler",
    description:
      "Comprehensive ship chandling services including supplies, repairs, and maintenance for vessels calling at Bangladeshi ports.",
    icon: FaShip,
    Link: "/services/ship-chandling",
  },
  {
    id: 2,
    title: "Export",
    description:
      "Professional export solutions connecting your products to global markets with full documentation and logistics support.",
    icon: FaExchangeAlt,
  ...
  },
  {
    ...
    title: "Import",
    description:
      "Seamless import services handling customs clearance, documentation, and delivery of international cargo.",
    icon: FaBoxOpen,
  ...
  },
  {
    ...
    title: "Suppliers",
    description:
      "Reliable supplier network ensuring quality products and timely delivery for all maritime and logistics needs.",
    icon: FaStore,
  ...
  },
  {
    ...
    description:
      "Additional specialized services including freight forwarding, warehousing, and supply chain solutions.",
    icon: FaCogs,
...
export const formFields: FormField[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Port Agency", value: "port-agency" },
...
export const MapData = {
  ...
  mapLink:
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3670.123456789!2d91.8052902!3d22.3160123!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30acdf3109109833%3A0x81e87d5a9230dcd6!2sFakirhat%20MQ%20Plaza!5e0!3m2!1sen!2sbd!4v1700000000000!5m2!1sen!2sbd",
};
...
export interface ContactDetail {
  email: string;
  phone?: string;
  locationUrl?: string; // এটি যোগ করা হয়েছে
...
export const contactDepartments: Department[] = [
  {
    ...
    details: [
      {
        email: "ship-chandler@aoslandtc.com",
        phone: "+880 1886337477",
        iconType: "ship",
      },
    ],
  ...
  },
  {
    ...
    details: [
      {
        email: "import@aoslandtc.com",
        phone: "+880 1727380822",
        iconType: "ship",
      },
    ],
  },
